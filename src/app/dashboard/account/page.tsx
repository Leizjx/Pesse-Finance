    ...
    <div className="flex-1 flex flex-col h-full overflow-y-auto pr-2 pb-24 lg:pb-10 relative">
          ...
          <div className="neumorphic p-8 rounded-large">
            ...
            <div className="flex flex-col sm:flex-row gap-8 items-center sm:items-start">
              ...
              <div className="relative shrink-0">
                ...
                <button className="absolute bottom-0 right-0 w-10 h-10 bg-[var(--color-primary)] rounded-full flex items-center justify-center text-[var(--color-on-surface)] shadow-sm hover:scale-105 transition-transform cursor-pointer">
                  <Upload size={18} />
                </button>
              </div>
      ...
      <footer className="mt-12 flex flex-col items-center gap-4 shrink-0">
        ...
        <p className="text-xs text-[var(--color-on-surface-variant)] font-medium">
          © 2024 Pesse Digital. All Rights Reserved.
        </p>
      </footer>
    </div>
  );
